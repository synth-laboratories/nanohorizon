...
from .http_shim import build_prompt_context as http_build_prompt_context, render_prompt_turn
...
def build_prompt_context(
    ...
    *,
    ...
    return http_build_prompt_context(observation, history, metadata=metadata)
