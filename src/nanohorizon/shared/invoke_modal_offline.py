...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        default="configs/craftax_offline_reference.yaml",
    )
    parser.add_argument("--output-dir", default="")
    parser.add_argument("--teacher-model", default="Qwen/Qwen3.5-9B")
    parser.add_argument("--teacher-api-key", default="")
    parser.add_argument("--teacher-enforce-eager", type=int, default=1)
    parser.add_argument("--teacher-max-model-len", type=int, default=None)
    parser.add_argument("--teacher-max-num-seqs", type=int, default=None)
    parser.add_argument("--teacher-gpu-memory-utilization", type=float, default=None)
    ...
    parser.add_argument("--allowed-teacher-achievements", default="")
    parser.add_argument("--craftax-container-url", default="")
    parser.add_argument("--craftax-container-worker-token", default="")
...
def main() -> None:
    ...
    with modal.enable_output():
        result = function.remote(
            ...
            teacher_max_num_seqs=args.teacher_max_num_seqs,
            ...
            allowed_teacher_achievements=args.allowed_teacher_achievements,
            craftax_container_url=args.craftax_container_url,
            craftax_container_worker_token=args.craftax_container_worker_token,
