...
IMAGE_NAME="${NANOHORIZON_RUNPOD_IMAGE:-ghcr.io/synth-laboratories/nanohorizon-base:latest}"
AUTO_INSTALL="${NANOHORIZON_AUTO_INSTALL:-1}"
...
echo "  gpu: $(nanoh_runpod_gpu_desc) x$GPU_COUNT"
